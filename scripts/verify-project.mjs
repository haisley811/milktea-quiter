...
assert.match(preview, /data-blink="images\/girl-stage-\$\{currentStage\}-blink\.png"/);
assert.match(preview, /data-wave="images\/girl-stage-\$\{currentStage\}-wave\.png"/);
...
assert.match(file("components/CharacterDisplay.tsx"), /character-outfit/);
